...
import { l as Route, B as Button, u as updateRecipe } from "./router-8Gksb7T5.js";
...
function RouteComponent() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex flex-col", children: /* @__PURE__ */ jsx("main", { className: "flex-1 container py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4 mb-6", children: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", asChild: true, children: /* @__PURE__ */ jsxs(Link, { to: "/recipes/$id", params: {
      id
    }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-2", children: "Edit Recipe" }),
      /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground", children: [
        'Update the "',
        /* @__PURE__ */ jsx("i", { children: recipe.title }),
        '" recipe details.'
      ] })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-8", children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsxs(Select, { value: formData.difficulty?.toLocaleLowerCase() ?? "Medium", onValueChange: (value) => setFormData({
                ...formData,
                difficulty: value
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "overview" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
        /* @__PURE__ */ jsx(Button, { type: "submit", disabled: !isFormValid || isSubmitting, className: "flex-1 md:flex-none", children: isSubmitting ? "Updating Recipe..." : "Update Recipe" }),
